...
def compute_opt_config_sum_inf():
    ...
    best_config, cost_rand = methods.greedy_selection(points, poses, K, num_cands)
...
if __name__ == '__main__':
    ...
    best_config_circle, cost_circle = methods.greedy_selection(points, poses_circle, K, num_cands, methods.Metric.min_eig)
    ...
    best_config_side, cost_side = methods.greedy_selection(points, poses_side, K, num_cands)
    ...
    best_config, cost_forward = methods.greedy_selection(points, poses, K, num_cands)
